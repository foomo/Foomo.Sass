	...
	public function compile()
	{
		...
		if (
			...
			if($this->compress) {
				...
				// suppress the creation of a source map, which is generated by default
				$arguments[] = '--no-source-map';
			} else {
				$arguments[] = 'expanded'; //'nested';
				// source maps are generated by default, so no option here for npm based sass
				//$arguments[] = '--sourcemap';
			}
			/*
			...
			*/
			$executableFile = 'sass'; // changed to npm based sass compiler
